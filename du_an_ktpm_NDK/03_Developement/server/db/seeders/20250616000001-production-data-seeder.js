  ...
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.bulkInsert('NhanKhau', [
        {
          hoTen: 'Nguyễn Văn A',
          ngaySinh: new Date('1980-01-11'),
          gioiTinh: 'Nam',
          danToc: 'Kinh',
          tonGiao: 'Phật giáo',
          cccd: '0012345678901',
          ngayCap: new Date('2021-01-15'),
        ...
        {
          hoTen: 'Tòng Thị B',
          ngaySinh: new Date('1988-07-22'),
          gioiTinh: 'Nữ',
          danToc: 'Kinh',
          tonGiao: 'Công giáo',
          cccd: '001234567890',
          ngayCap: new Date('2021-02-20'),
          noiCap: 'Cục Cảnh sát QLHC về TTXH - Hà Nội',
          ngheNghiep: 'Giaos sư',
          ghiChu: 'Vợ chủ hộ',
          createdAt: new Date(),
