...
const HomepageToTruong: React.FC = () => {
      ...
      <Layout role="totruong">
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p className="text-base text-indigo-100 mt-2">Đang tải dữ liệu...</p>
          </div>
          <div className="flex justify-center items-center h-64">
            <div className="text-white/80">Đang tải thống kê...</div>
          </div>
        </div>
      </Layout>
    );
  ...
  <Layout role="totruong">
    <div className="flex flex-col gap-8">
      ...
      <div>
        <h1 className="text-3xl font-bold text-white">TRANG CHỦ</h1>
        <p className="text-base text-indigo-100 mt-2">Chào mừng đến với Hệ thống Quản lý Thu phí Chung cư</p>
      </div>

      {/* Info Cards Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Tổng số Nhân khẩu */}
        <div className="bg-white/95 backdrop-blur-md rounded-lg shadow-xl border border-indigo-200/50 p-6 flex flex-col gap-4">
          <h2 className="text-xl font-semibold text-gray-700">Tổng số Nhân khẩu</h2>
          <div className="flex items-baseline gap-2">
            <span className="text-5xl font-bold text-indigo-600">{totalResidents.toLocaleString()}</span>
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-lg shadow-xl border border-indigo-200/50 p-6 flex flex-col gap-4">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-5xl font-bold text-indigo-600">{temporaryResidents}</span>
            <span className="text-xl text-gray-700">nhân khẩu</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-lg shadow-xl border border-indigo-200/50 p-6 flex flex-col gap-10">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-lg shadow-xl border border-indigo-200/50 p-6 flex flex-col gap-4">
          ...
          <div className="flex gap-4 justify-center mt-2">
            <div className="flex items-center gap-1">
              <span className="w-4 h-4 bg-indigo-500 rounded-full inline-block"></span>
