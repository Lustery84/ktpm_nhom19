  ...
  return (
    <Layout role="totruong">
      <div className="p-4 flex flex-col gap-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">THỐNG KÊ NHÂN KHẨU</h1>
          <p className="text-indigo-100 text-sm mt-1">Thống kê dữ liệu nhân khẩu thực tế từ hệ thống</p>
        </div>

        {/* Filter Area */}
        <div className="flex flex-wrap items-center gap-4">
          <label className="font-semibold text-white">Thống kê theo:</label>
          <select
