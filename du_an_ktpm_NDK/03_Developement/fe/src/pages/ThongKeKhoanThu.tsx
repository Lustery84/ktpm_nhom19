  ...
  return (
    <Layout role="ketoan">
      <div className="p-4 flex flex-col gap-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">THỐNG KÊ KHOẢN THU</h1>
          <p className="text-indigo-100 text-sm mt-1">Thống kê dữ liệu thu phí thực tế từ hệ thống</p>
        </div>
